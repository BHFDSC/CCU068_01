...
personal_info_CHD_controls <- tbl(con, in_catalog("hive_metastore", "", "ccu068_controls_matched_personal_info_post_vaccination")) %>% 
  select(NHS_number, ethnicity, sex, DOB, gp_practice)
CHD_controls_covid <- tbl(con, in_catalog("hive_metastore", "", "ccu068_controls_matched_covid_post_vaccination"))

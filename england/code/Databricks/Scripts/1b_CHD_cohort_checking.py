...
snomed_exclusion_codes = spark.table('hive_metastore..chd_exclusion_snomed').select('snomed_ct_concept_id').withColumnRenamed('snomed_ct_concept_id','code')

icd10_exclusion_codes = spark.table('hive_metastore..icd_confounder_codes').select('icd_10').withColumnRenamed('icd_10','code')

opcs4_exclusion_codes = spark.table('hive_metastore..opcs_confounder_codes').select('opcs_4_code').withColumnRenamed('opcs_4_code','code')
...
code_dictionary = spark.table('hive_metastore..congenital_heart_disease_code_descriptions')
...
CHD_cases = spark.table(f'.chd_cases_ccu068_{window}')

gdppr_controls = spark.table(f'.gdppr_controls_ccu068_{window}')
hes_apc_controls = spark.table(f'.hes_apc_controls_ccu068_{window}')
hes_op_controls = spark.table(f'.hes_op_controls_ccu068_{window}')
